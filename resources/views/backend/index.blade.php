            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col mr-2">
                        ...
                        @endphp
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $booking_data }}</div>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        @php
                            // $booking_data = App\Models\Booking::all()->count();
                            $total_room = App\Models\Room::count();
                        @endphp
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $total_room }}</div>
                        {{-- <div class="mt-2 mb-0 text-muted text-xs">
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        @php
                            ...
                            $total_customer = App\Models\Booking::groupBy('customer_phone')->count();
                            // $total_customer = App\Models\Booking::groupBy('customer_phone')->select('customer_phone', DB::raw('count(*) as total'))->get();
                            // $total_customer = DB::table('bookings')
