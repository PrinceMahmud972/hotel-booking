            ...
            <div class="card-body">
                <form action="{{ route('backend.service.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="service_icon" class="form-control" id="serviceIcon" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="service_desc" id="serviceDesc" cols="30" rows="4"></textarea>
                    </div>
