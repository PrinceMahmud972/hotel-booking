<script type="text/javascript" src="{{ asset('frontend/assets/js/jquery-1.11.0.min.js') }}"></script>
...
<script type="text/javascript" src="{{ asset('frontend/assets/js/jquery.nicescroll.js') }}"></script>
<script type="text/javascript" src="{{ asset('frontend/assets/js/jquery.prettyPhoto.js') }}"></script>
<script type="text/javascript" src="{{ asset('frontend/assets/js/jquery-ui-1.10.4.custom.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('frontend/assets/js/jquery.forms.js') }}"></script>
...
<script type="text/javascript" src="{{ asset('frontend/assets/rs-plugin/js/jquery.themepunch.tools.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('frontend/assets/rs-plugin/js/jquery.themepunch.revolution.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('frontend/assets/js/switch.js') }}"></script>
